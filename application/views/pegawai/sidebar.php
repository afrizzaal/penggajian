  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
        <div class="sidebar-brand-text mx-3"> <img class="img-fluid" src="<?= base_url() ?>assets/img/mgm.png"></div>
      </a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('pegawai/profile'); ?>">
      ...
      <!-- Nav Item - Tables -->
      <li class="nav-item">
        <a class="nav-link" href="<?= base_url('welcome/logout'); ?>" onclick="return confirm('Apakah anda akan keluar?')">
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
          ...
          <h5 class="font-weight-bold">APLIKASI PENGGAJIAN <br><b class="text-primary">PT. MULTIMODA GUNA MANDIRI</b></h5>
