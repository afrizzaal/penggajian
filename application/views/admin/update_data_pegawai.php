  ...
  <div class="card" style="width: 60%; margin-bottom:100px;">
    <div class="card-body">
      ...
      <?php foreach ($pegawai as $p) : ?>
        ...
        <form action="<?= base_url('admin/data_pegawai/update_data_aksi') ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="form-group">
            ...
            <input type="text" name="password" class="form-control" value="<?= $p->password; ?>" <?= form_error('password', '<div class="text-small text-danger">', '</div>') ?> </div> <div class="form-group">
