  ...
  <div class="card mb-3">
    ...
    <div class="card-body">
      <form class="form-inline">
        ...
        <button type="submit" class="btn btn-primary mb-3 ml-auto"><i class="fas fa-eye"></i> Generate</button>
      </form>
    </div>
  </div>
  ...
  <form method="POST">
    ...
    <table class="table table-bordered table-striped">
      <tr>
        ...
        <td class="text-center" width="7%">Hadir</td>
        <td class="text-center" width="7%">Sakit</td>
        <td class="text-center" width="7%">Alpha</td>
      </tr>
      ...
      foreach ($input_absensi as $a) : ?>
        <tr>
          ...
          <td class="text-center"><input type="number" name="hadir[]" class="form-control" value="0"></td>
          <td class="text-center"><input type="number" name="sakit[]" class="form-control" value="0"></td>
          <td class="text-center"><input type="number" name="alpha[]" class="form-control" value="0"></td>
        </tr>
      <?php endforeach; ?>
    </table>
  </form>
